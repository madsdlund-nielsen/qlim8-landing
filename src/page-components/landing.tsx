...
const CAROUSEL_SCREENSHOTS = [
  { src: carouselTour.src, label: "Onboarding" },
  { src: carouselDashboard.src, label: "Dashboard" },
  { src: carouselDatakilder.src, label: "Datakilder" },
  { src: carouselUdledninger.src, label: "Udledninger" },
  { src: carouselTiltag.src, label: "Tiltag" },
  { src: carouselScenarier.src, label: "Scenarier" },
  { src: carouselRapportering.src, label: "Rapportering" },
  { src: carouselBragboard.src, label: "Offentlig profil" },
];

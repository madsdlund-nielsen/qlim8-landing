...
export const artikel: Article = {
  ...
  sections: [
    ...
    {
      type: 'paragraph',
      text: 'Loven gør Danmark til et af de første lande i Europa med klare, bindende krav om at integrere ESG i den finansielle sektors kerneforretning. Reglerne er bygget oven på Den Europæiske Banktilsynsmyndigheds (EBA) retningslinjer, der også trådte i kraft i 2026.',
    },
    {
      type: 'paragraph',
      text: 'Kernen i L193 er simpel: banker, realkreditinstitutter og kapitalforvaltere skal nu identificere, måle og rapportere miljømæssige, sociale og ledelsesmæssige risici i deres risikostyring og kreditvurdering. Det er ikke længere noget, bankerne kan vælge at gøre frivilligt. Det er noget, de skal gøre, og noget, Finanstilsynet vil føre tilsyn med, at de gør.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Danske Bank fik et påbud om at styrke analyserne på både portefølje- og kundeniveau, herunder for kunders omstillingsplaner og dataindsamling, og om at etablere effektive kreditkontroller på området.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Og så er der den nuance, som bankrådgiveren typisk ikke uddyber: branchedata er, definitionsmæssigt, et gennemsnit. Et gennemsnit er kun præcist for en lille gruppe lige omkring midten. For halvdelen af virksomhederne er det for højt, for den anden halvdel for lavt.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Her bliver det interessant, og det er her, de fleste artikler om L193 bliver upræcise. Det er ikke ét sæt spørgsmål. Det er meget branchespecifikt.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'De spørgsmål, jeg ser bankerne typisk stille SMV-kunder, kan grupperes:',
    },
    {
      type: 'paragraph',
      text: 'På klimasiden: Hvor stort er jeres energiforbrug? Hvilken type? Har I lavet et CO₂-regnskab? Har I planer for reduktion? Hvad er jeres eksponering mod fysiske klimarisici (oversvømmelse, tørke), og mod omstillingsrisici (regulering, kundepreferencer)?',
    },
    {
      type: 'paragraph',
      text: 'På værdikædesiden: Stiller jeres største kunder ESG-krav til jer? Stiller I selv krav til jeres leverandører? Hvilken andel af jeres omsætning kommer fra kunder, der selv er CSRD-omfattet?',
    },
    {
      type: 'paragraph',
      text: 'På governance-siden: Hvem i ledelsen har ansvar for bæredygtighedsarbejdet? Er der politikker for ansvarlig forretningsadfærd? Hvordan håndterer I medarbejderforhold?',
    },
    {
      type: 'paragraph',
      text: 'Det er ikke en udtømmende liste, og det er ikke spørgsmål, du behøver besvare med 30 sider af dokumentation. Men det er den slags spørgsmål, du bør have konkrete, dokumenterede svar på, før du sætter dig til bankmødet.',
    },
    ...
    {
      type: 'paragraph',
      text: 'VSME er udviklet af EFRAG, den europæiske organisation der står bag de officielle bæredygtighedsstandarder (ESRS). Den er bygget specifikt til små og mellemstore virksomheder som et tilgængeligt alternativ til den tunge CSRD-rapportering.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Det er sådan en lille teknisk detalje, som ingen fortæller dig, indtil du har spildt 20 timer på den forkerte ting.',
    },

    { type: 'h2', text: 'De tre veje til klar dokumentation' },
    {
      type: 'paragraph',
      text: 'Når jeg taler med danske SMV-ejere, der står overfor det første ESG-bankmøde, lander samtalen næsten altid på samme tre veje. Lad mig være ærlig om hvad hver af dem reelt indebærer.',
    },
    { type: 'h3', text: 'Vej 1: Hyr en konsulent' },
    {
      type: 'paragraph',
      text: 'En dygtig bæredygtighedskonsulent koster typisk mellem 1.200 og 1.800 kroner i timen, og et komplet VSME Basis-regnskab tager erfaringsmæssigt 30-50 konsulenttimer for en mellemstor SMV. Det giver en regning på 36.000-90.000 kroner for ét regnskab.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Det er ikke et angreb på konsulenterne. Det er en arbejdsdeling: lad softwaren tage rugbrødsarbejdet, og brug konsulenten på det, hvor menneskelig dømmekraft reelt skaber værdi. Mange af de bedste konsulentforhold jeg ser, bruger software i baggrunden og fokuserer deres timer på strategi og rådgivning. Det er den moderne tilgang, og den er bedst for begge parter.',
    },

    { type: 'h2', text: 'Hvad du faktisk skal kunne dokumentere' },
    {
      type: 'paragraph',
      text: 'Lad mig være konkret om, hvad jeg mener, en bankklar ESG-dokumentation faktisk skal indeholde. Det her bygger på min egen erfaring med at bygge qlim8, og på de samtaler jeg har haft med revisorer og bankrådgivere over de sidste to år.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'For det fjerde: din rapport skal være i et format, banken kan bruge. Det betyder VSME-skabelonen fra EFRAG. Helst i Excel-format hvor de kan trække data ud automatisk. PDF-rapporter kan supplere, men ikke erstatte, det maskinlæsbare format.',
    },
    {
      type: 'paragraph',
      text: 'Det er det. Det er ikke raketvidenskab, men det er heller ikke noget, du klarer på en eftermiddag, hvis du starter fra bunden i Excel.',
    },

    { type: 'h2', text: 'Hvad du kan gøre nu' },
    {
      type: 'paragraph',
      text: 'Hvis du er ejer-leder af en dansk SMV, der står overfor sin første ESG-samtale med banken, er her hvad jeg vil anbefale dig at gøre i den næste måned.',
    },
    {
      type: 'paragraph',
      text: 'Tag et møde med din bankrådgiver, før hun spørger først. Spørg konkret: "Hvilke ESG-data vil I have fra os til næste statussamtale? I hvilket format? Hvilken bredde og dybde?" De fleste bankrådgivere vil sætte stor pris på, at du er proaktiv, og du undgår at blive overrasket. Du finder også typisk ud af, at de er mindre præcise om kravene, end markedsføringsmaterialet fra konsulenterne antyder. Det er meget afslørende.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Men det betyder, at det at have ordentlig dokumentation går fra at være en konkurrencefordel til at være et basiskrav. Og det betyder, at SMV\'er, der venter med at få styr på det, og som sidder med fragmenterede data spredt over fakturaer og Excel-ark, kommer til at bruge urimeligt meget tid og energi på det, når banken eller den store kunde stiller spørgsmålet.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Den ESG-dokumentation, der bliver bedst i Danmark de næste fem år, kommer ikke fra de virksomheder, der gør det dyrest. Den kommer fra dem, der gør det mest konsekvent.',
    },
    {
      type: 'paragraph',
      text: 'Og den ærlighed, du dokumenterer i dine data, er præcis den ærlighed, der gør, at både banken, kunderne og din egen ledelse kan stole på det, du leverer. Det er ikke en feature. Det er pointen.',
    },
  ],
}
